...
<template>
  <button class="lg:hidden block text-gray-600" @click="isMenuOpen = !isMenuOpen">
    ☰
  </button>
  <aside :class="isMenuOpen ? 'block' : 'hidden'" class="w-72 bg-white shadow-md p-4 lg:block">
    ...
    <button class="w-full py-2 bg-red-600 text-white font-medium rounded-md hover:bg-red-700 mt-20">
      Keluar
    </button>
  </aside>
</template>
